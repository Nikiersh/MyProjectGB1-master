...
/**
 * Implementation of a time slider controller for the ZD version of the AnimTimeline.
 */
class FPaperZDAnimTimeSliderController : public ITimeSliderController
{
public:
	//ctor
	FPaperZDAnimTimeSliderController(const FTimeSliderArgs& InArgs, TWeakPtr<FPaperZDAnimModel> InWeakModel, TWeakPtr<SPaperZDAnimTimeline> InWeakTimeline);
...
private:
	...
	TWeakPtr<SPaperZDAnimTimeline> WeakTimeline;

	/** Time Slider arguments passed when creating the controller. */
