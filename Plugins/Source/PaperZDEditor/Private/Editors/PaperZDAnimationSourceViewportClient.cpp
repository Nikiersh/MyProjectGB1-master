...
FPaperZDAnimationSourceViewportClient::FPaperZDAnimationSourceViewportClient(TWeakObjectPtr<const UPaperZDAnimationSource> InAnimationSourcePtr) : FEditorViewportClient(new FAssetEditorModeManager())
{
