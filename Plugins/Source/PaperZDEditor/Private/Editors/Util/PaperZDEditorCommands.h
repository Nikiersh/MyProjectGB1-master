...
public:
	...
	FPaperZDEditorCommands()
		: TCommands<FPaperZDEditorCommands>(TEXT("PaperZDEditorCommands"), NSLOCTEXT("PaperZDContexts", "PaperZDEditorCommands", "PaperZD Editor"), NAME_None, FEditorStyle::GetStyleSetName())
	{}
